 ...
 *
 * @author Bela Ban
 * @version $Id: JChannel.java,v 1.1 2009/07/30 00:58:13 phperret Exp $
 */
public class JChannel extends Channel {
     ...
     *                          initialization of the protocol stack.
     */
    public JChannel(URL properties, View creator) throws ChannelException {
    	this.my_view=creator;
    }
     ...
     *                          initialization of the protocol stack.
     */
    public JChannel(String properties, View creator) throws ChannelException {
        this.my_view=creator;
        init(properties);
    }
    ...
    public synchronized void connect(String cluster_name) throws ChannelException {
        ...
        try {
            ...
            throw new ChannelException("failed to start protocol stack: "+ e.getLocalizedMessage(), e);
        }
	...
	protected final void init( String props) throws ChannelException {
        if(log.isInfoEnabled())
            log.info("JGroups version: " + Version.description);
        try {
            prot_stack=new ProtocolStack(this, props);
