// $Id: IpAddress.java,v 1.1 2009/07/30 00:58:14 phperret Exp $
...
//    }
    ...
    public static IpAddress getNextAvailableIp( int port ) throws UnknownHostException{
        String arg0= Util.getIpStringFromBytes( new byte[]{ (byte)192, (byte)168, 0, ++nextByte}) ;
        IpAddress addr= new IpAddress( arg0, port);
        return addr;
    }
