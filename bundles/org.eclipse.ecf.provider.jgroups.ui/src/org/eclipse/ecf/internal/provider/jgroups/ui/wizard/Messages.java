...
public class Messages extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.ecf.provider.jgroups.ui.messages"; //$NON-NLS-1$
	public static String JoinGroupWizardPage_GroupNameRequired;
