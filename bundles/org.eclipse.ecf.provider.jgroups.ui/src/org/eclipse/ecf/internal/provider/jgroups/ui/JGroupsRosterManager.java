...
import org.eclipse.ecf.presence.PresenceContainer;
...
public class JGroupsRosterManager extends AbstractRosterManager {

	private List presenceListeners = new LinkedList();

	private IPresenceContainerAdapter presenceContainer;

	public JGroupsRosterManager(IPresenceContainerAdapter presenceContainer, IUser user) {
		super();
