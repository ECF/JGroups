...
public class JGroupsConfigTest extends JGroupsContainerTest {
	 ...
	 * stackConfigID (see extension in o.e.e.jgroups plugin) 'bas_config' is NOT
	 * present so an error is detected.
	 */
	...
	/**
	 * overrided to not run this test which is run in
	 * {@link JGroupsContainerTest}
	 */
	@Override
